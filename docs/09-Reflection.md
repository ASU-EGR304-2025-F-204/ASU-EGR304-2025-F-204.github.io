...
* Creating a high quality corresponding PCB schematic with custom footprints
* Something being complex does not make it good
* Efficent wire management
* Soldering a PCB (or anything)
* Debugging hardware through use of an oscilliscope and/or multimeter
...
4. If your system isn't outputting a signal, use a multimeter and check for power between components in case one component is fried and needs to be replaced.
5. Use as minimal an amount of wires as possible (this makes it easier to follow and therefore debug).
